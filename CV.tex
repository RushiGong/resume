...
\begin{itemize}
  ...
  \begin{itemize*}
    ...
    \item Developed thermodynamic databases with uncertainty quantification for molten salts, including Cr and Ni in FLiNaK and LaCl3 in LiCl-KCl, through high-throughput computational thermodynamics to improve the accuracy of predicting thermodynamic properties of molten salts solids and liquids.
    \item Applied Bayesian statistics and model selections in CALPHAD modeling, achieved the evaluation and comparison of different liquid solution models, effectively optimized models through the Markov Chain Monte Carlo method, and quantified uncertainty to enhance the accuracy and reliability of thermodynamic models.
